...
const char* dataset;
  ...
  if(std::string(directory) == std::string("eleTau_2jet0tag"             )){ dataset = "e#tau_{h}, 2jet-0tag";          }
  ...
  if(std::string(directory) == std::string("eleTau_2jet1tag"             )){ dataset = "e#tau_{h}, 2jet-1tag";       }
  ...
  if(std::string(directory) == std::string("eleTau_2jet2tag"             )){ dataset = "e#tau_{h}, 2jet-2tag";         }
